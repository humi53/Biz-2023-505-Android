  ...
  void loadStationXml() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final jsonBody = Xml2Json()..parse(xmlBody);

        final jsonDecode = json.decode(jsonBody.toParker());

        final stationList =
            jsonDecode["ns2:STATION_INFO"]["STATION_LIST"]["STATION"];
        //["ns2"]; //["STATION_LIST".toString()];
//{ns2:STATION_INFO: {STATION_LIST: {STATION: [{BUSSTOP_ID
