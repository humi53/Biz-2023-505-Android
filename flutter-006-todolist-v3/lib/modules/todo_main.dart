...
class _StartPage extends State<StartPage> {
    ...
    return Scaffold(
      ...
      body: GestureDetector(
          ...
          child: FutureBuilder(
            ...
            // 여기에서 가져온 데이터는 builder 에게 snapshot 에 담아서 전달
  ...
  /// ListView 의 return type 을 Widget으로 변경하기
